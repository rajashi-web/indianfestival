...
if( ! class_exists( 'Masonry_Blog_Custom_Fields' ) ) :

	class Masonry_Blog_Custom_Fields {
		...
		public function register_post_meta() {   
		    ...
		    add_meta_box( 'sidebar_position_metabox', esc_html__( 'Sidebar Position', 'masonry-blog' ), array( $this, 'sidebar_position_meta' ), array( 'post', 'page' ), 'side', 'default' );
		}
		...
		public function sidebar_position_meta() {
			...
			$sidebar_position_key = 'masonry_blog_sidebar_position';
		    ...
		    $choices = array(
		        ...
		        'none' => esc_html__( 'Fullwidth', 'masonry-blog' ),
		    );
		...
		public function save_sidebar_position_meta() {
		    ...
		    if( isset( $_POST['sidebar_position'] ) ) {
				...
				update_post_meta( $post->ID, 'masonry_blog_sidebar_position', sanitize_text_field( wp_unslash( $_POST['sidebar_position'] ) ) ); 
			}
		}
	}
endif;

$masonry_blog_custom_fields = new Masonry_Blog_Custom_Fields();