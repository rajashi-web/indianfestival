		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<div class="spicepress-tab-pane-half spicepress-tab-pane-first-half">
					...
					<a href="<?php echo esc_url('https://demo.spicethemes.com/?theme=SpicePress%20Lite'); ?>" target="_blank"  class="info-block"><div class="dashicons dashicons-desktop info-icon"></div>
