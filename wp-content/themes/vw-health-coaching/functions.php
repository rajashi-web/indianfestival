...
function vw_health_coaching_activation_notice() {
	...
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_health_coaching_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'vw-health-coaching' ) .'</a></p>';
	echo '<p>'. esc_html__( 'Install VW Health Coaching Using Ibtana Website Builder & Build your website easily.
.', 'vw-health-coaching' ) .'</p>';
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=vw_health_coaching_guide&tab=gutenberg_editor' ) ) .'" class="button button-primary">'. esc_html__( 'START WITH GUTENBERG BLOCKS', 'vw-health-coaching' ) .'</a></p>';
	echo '</div>';
}
...
function vw_health_coaching_sanitize_email( $email, $setting ) {
...
if ( ! function_exists( 'vw_health_coaching_credit' ) ) {
	function vw_health_coaching_credit(){
		echo "<a href=".esc_url(VW_HEALTH_COACHING_CREDIT).">".esc_html__('Coaching WordPress Theme','vw-health-coaching')."</a>";
	}
}
