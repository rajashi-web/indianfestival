...
function vw_health_coaching_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_health_coaching_loader_icon',array(
        'default' => 'Two Way',
        'sanitize_callback' => 'vw_health_coaching_sanitize_choices'
	));
	$wp_customize->add_control('vw_health_coaching_loader_icon',array(
        'type' => 'select',
        'label' => __('Pre-Loader Type','vw-health-coaching'),
        'section' => 'vw_health_coaching_left_right',
        'choices' => array(
            'Two Way' => __('Two Way','vw-health-coaching'),
            'Dots' => __('Dots','vw-health-coaching'),
            'Rotate' => __('Rotate','vw-health-coaching')
        ),
	) );
	...
	$wp_customize->add_setting('vw_health_coaching_email_address',array(
		'default'=> '',
		'sanitize_callback'	=> 'vw_health_coaching_sanitize_email'
	));	
	...
	$wp_customize->add_control(new VW_Health_Coaching_Fontawesome_Icon_Chooser(
		...
		'label'	=> __('Add Services Button Icon','vw-health-coaching'),
		'transport' => 'refresh',
		'section'	=> 'vw_health_coaching_service_section',
	...
	$wp_customize->add_control(new VW_Health_Coaching_Fontawesome_Icon_Chooser(
		...
		'label'	=> __('Add Button Icon','vw-health-coaching'),
		'transport' => 'refresh',
		'section'	=> 'vw_health_coaching_button_settings',
	...
	$wp_customize->add_setting( 'vw_health_coaching_metabox_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_health_coaching_switch_sanitization'
    ));  
    $wp_customize->add_control( new VW_Health_Coaching_Toggle_Switch_Custom_Control( $wp_customize, 'vw_health_coaching_metabox_hide_show',array(
      'label' => esc_html__( 'Show / Hide Metabox','vw-health-coaching' ),
      'section' => 'vw_health_coaching_responsive_media'
    )));
...
final class VW_Health_Coaching_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(new VW_Health_Coaching_Customize_Section_Pro($manager,'vw_health_coaching_get_started_link',array(
			...
			'pro_url'  => admin_url('themes.php?page=vw_health_coaching_guide'),
		)));
	}
