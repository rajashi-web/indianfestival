...
<html <?php language_attributes(); ?>>
	...
	?>
		...
		<header role="banner">
    		<a class="screen-reader-text skip-link" href="#maincontent"><?php esc_html_e( 'Skip to content', 'vw-health-coaching' ); ?></a>
		...
		<?php if(get_theme_mod('vw_health_coaching_loader_enable',true)==1){ ?>
		  <div id="preloader">
		    <div id="status">
		      <?php $vw_health_coaching_theme_lay = get_theme_mod( 'vw_health_coaching_loader_icon','Two Way');
		        if($vw_health_coaching_theme_lay == 'Two Way'){ ?>
		        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/two-way.gif" alt="" role="img"/>
		      <?php }else if($vw_health_coaching_theme_lay == 'Dots'){ ?>
		        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/dots.gif" alt="" role="img"/>
		      <?php }else if($vw_health_coaching_theme_lay == 'Rotate'){ ?>
