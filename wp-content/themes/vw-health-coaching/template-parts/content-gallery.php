...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box">
    ...
    <div class="new-text">
      ...
      <?php if( get_theme_mod( 'vw_health_coaching_toggle_postdate',true) != '' || get_theme_mod( 'vw_health_coaching_toggle_author',true) != '' || get_theme_mod( 'vw_health_coaching_toggle_comments',true) != '') { ?>
        <div class="post-info">
          <?php if(get_theme_mod('vw_health_coaching_toggle_postdate',true)==1){ ?>
            <i class="fas fa-calendar-alt"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $vw_health_coaching_archive_year, $vw_health_coaching_archive_month, $vw_health_coaching_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span>|</span>
          <?php } ?>
          ...
          <?php if(get_theme_mod('vw_health_coaching_toggle_comments',true)==1){ ?>
            <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'vw-health-coaching'), __('0 Comments', 'vw-health-coaching'), __('% Comments', 'vw-health-coaching') ); ?> </span>
          <?php } ?>
          <hr>
        </div>
      <?php } ?>
