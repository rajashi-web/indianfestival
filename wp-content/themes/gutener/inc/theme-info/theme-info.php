...
if ( ! class_exists( 'Gutener_Theme_Info' ) ) {
    class Gutener_Theme_Info{
        ...
        public function prepare_class() {
            ...
            $this->page_title    = $this->theme_name . esc_html__(' Info','gutener');
            $this->menu_title    = $this->theme_name . esc_html__(' Info','gutener');
        ...
        public function free_pro() {
            ...
            if ( ! empty( $free_pro ) ) {
                ...
                if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
                    ...
                    echo '<tr>';
                    echo '<th></th>';
                    echo '<th>' . sprintf( '%s', $this->theme_name ) . '</th>';
...
$config = array(
    ...
    // Main welcome title
    'info_title' => sprintf( esc_html__( 'Welcome to %s - ', 'gutener' ), $theme_name_config ),

    // Main welcome content
    'info_content' => sprintf( esc_html__( '%s is now installed and ready to use. We hope the following information will help you. If you want to ask any query or just want to say hello, you can always contact us. We hope you enjoy it! ', 'gutener' ), '<b>'.$theme_name_config.'</b>' ),
    ...
    'quick_links' => array(
        'theme_url'  => array(
            ...
            'url' => 'https://keonthemes.com/downloads/'.$theme_name_config_url
        ),
        'demo_url'  => array(
    ...
    'getting_started' => array(
        'first' => array(
           'title' => esc_html__( 'To fully take advantage of the best our theme can offer, getting started.', 'gutener' ),
            'link_title' => sprintf(esc_html__( 'Get started with %s','gutener' ), $theme_name_config ),
    ...
    'faq' => array(
        'first' => array (
            ...
            'desc' => sprintf(esc_html__( '%s supports Kirki and Gutentor.','gutener' ), $theme_name_config ),
            'is_new_tab' => true
        ),
    ),
    // Support content tab.
    'support_content' => array(
        ...
        'second' => array (
            ...
            'button_link' => esc_url( admin_url( 'customize.php' ), 'gutener' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'third' => array(
        ...
        'fourth' => array (
            ...
            'button_link' => esc_url( 'mailto:keonthemes@gmail.com', 'gutener' ),
            'is_button' => true,
            'is_new_tab' => true
        ),
        'fifth' => array(
    ...
    'rating' => array(
        'first'=> array(
            ...
            'desc' => esc_html__( 'If you like our work, please give us a moment of your time to rate our theme 5 stars on ','gutener' ) .'<a target="_blank" href="https://wordpress.org/support/theme/' .$theme_name_config_url. '/reviews/">' . 'wordpress.org' . '</a>' . esc_html__('. It will give us more energy to work on this theme.', 'gutener' ),
            'link_title' => esc_html__( 'Rate Theme','gutener' ),
            'link_url' => 'https://wordpress.org/support/theme/' .$theme_name_config_url. '/reviews/',
            'is_button' => true,
            'is_new_tab' => true
        )
    )
